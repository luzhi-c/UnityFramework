...
namespace GamePlay.Boot
{
    internal class FsmInitializePackage : IStateNode
    {
        ...
        {
            GameEntry.Event.Fire(this, PatchStcepsChangeArgs.Create("加载流程初始化"));
            GameEntry.Instance.StartCoroutine(InitPackage());
        }
        ...
        private IEnumerator InitPackage()
        {
            ...
            {
                var checkeVersion = (bool)m_Machine.GetBlackboardValue("CheckeVersion");
                if (checkeVersion)
                {
        ...
        private string GetHostServerURL()
        {
            ...
            {
                hostServerIP = "http://10.0.2.2"; //安卓模拟器地址
            }
